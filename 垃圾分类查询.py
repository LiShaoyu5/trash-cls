...
if __name__ == '__main__':
    ...
    st.title('环保校园的密码：垃圾分类与“重生”')

    st.write('你是否有过这样的感觉，有些东西明明刚买回来，转眼就变成了垃圾？刚刚清理过的教室垃圾桶，很快就堆满了杂物？')
    st.write('其实，这些都可以变成“资源魔法盒子”里的宝藏。只要我们进行垃圾分类，将可回收的宝藏们收集起来，它们就可能变成我们生活中的新宠，比如一袋全新的纸巾，或者一个漂亮的笔筒。垃圾分类就像在养一只可爱的环保“小精灵”，它会用魔法让我们的生活更加绿色、更加美好。')
    st.write('垃圾分类有助于资源的回收利用与再加工，降低了垃圾填埋和焚烧的需求，能减少有害物质对土壤和水源的污染，就仿佛给地球进行大清洗，或像是给她一顿美味的膳食，让天更蓝，水更清，让资源可持续，让文明永流传。')
    st.write('师生携手积极参与校园垃圾分类的环保行动，了解垃圾“重生”即垃圾回收再利用的技术，形成环保意识，创建环保校园，不仅能让工作和学习环境更加优美，也为生态宜居的未来贡献了一份力量。')
    st.write('那么，常见的校园垃圾该如何分类，又该如何回收处理呢？')
    st.write('快来搜索试试吧！')
