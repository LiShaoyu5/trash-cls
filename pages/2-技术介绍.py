...
st.markdown(
    ...
    1. 预训练模型的效果极大地依赖于训练的语料。百度在中文自然语言处理领域有深厚的技术积累，其业务场景也保证了训练数据的丰富性。文心模型经过三代发展，在中文自然语言处理任务上展现出了比BERT更好的效果，因此我们选择了文心模型。
    2. 我们希望项目能够在各种硬件环境上快速运行。BERT模型体积大、速度慢，而我们选择的ernie-3.0-nano-zh是从文心大模型上蒸馏而来，体积仅有BERT的五分之一，即使在物联网设备上也能快速运行。我们的设备没有显卡，但依然能够在几分钟内完成模型的训练。
